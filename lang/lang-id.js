...
const lang = {
  ...
  regex:{
    ...
    // Meta commands
    MetaUnfinish:/^selesai?$/,
    MetaHello:/^(?:halo|hi|yo)$|^\?$/,
    MetaHelp:/^bantuan$|^\?$/,
    MetaHint:/^(?:petunjuk|petunjuk-petunjuk)s?$/,
    MetaCredits:/^(?:tentang|kredit|versi|info)$/,
    MetaDarkMode:/^(?:gelap|mode gelap|togel gelap|togel mode gelap)$/,
    MetaAutoScrollMode:/^(?:gulir|otomatis gulir|togel gulir|togel otomatis gulir)$/,
    MetaNarrowMode:/^(?:sempit|mode sempit|togel sempit|togel mode sempit|ponsel|mode ponsel|togel ponsel|togel mode ponsel)$/,
    MetaPlainFontMode:/^(?:font|font sederhana|font sederhanas|fonts)$/,
    MetaWarnings:/^per(?:ingatan|ingatan|)$/,
    MetaImages:/^gambar$/,
    MetaSilent:/^(?:diam|diam)$/,
    MetaSpoken:/^diucapkan$/,
    MetaIntro:/^intro$/,
    MetaBrief:/^singkat$/,
    MetaTerse:/^singkat$/,
    MetaVerbose:/^detail$/,
    MetaTranscript:/^transkrip$|^naskah$/,
    MetaTranscriptStart:/^mulai transkrip$|^mulai naskah$/,
    MetaTranscriptOn:/^hidupkan transkrip$|^hidupkan naskah$/,
    MetaTranscriptOff:/^matikan transkrip$|^matikan naskah$/,
    MetaTranscriptClear:/^bersihkan transkrip$|^bersihkan naskah$|^hapus transkrip$|^hapus naskah$/,
    MetaTranscriptShow:/^tampilkan transkrip$|^tampilkan naskah$|^tampilkan naskah$|^tampilkan transkrip$|^tampilkan naskah$/,
    MetaTranscriptWalkthrough:/^(?:transkrip|naskah) jalan$/,
    MetaUserComment:/^(?:\*|\;)(.+)$/,
    MetaSave:/^simpan$/,
    MetaSaveGame:/^simpan (.+)$/,
    MetaFileSaveGame:/^fsave (.+)$/,
    MetaSaveOverwriteGame:/^simpan (.+) (?:tulis ulang|ow)$/,
    MetaLoad:/^(?:muat|muat ulang|kembalikan)$/,
    MetaLoadGame:/^(?:muat|muat ulang|kembalikan) (.+)$/,
    MetaFileLoadGame:/^(?:fmuat|fmulai|kembalikan)$/,
    MetaDir:/^(?:muat ulang|muat|kembalikan|dir|direktori|ls|simpan ls|simpan dir)$/,
    MetaDeleteGame:/^(?:hapus|del) (.+)$/,
    MetaUndo:/^undo$/,
    MetaAgain:/^(?:lagi|g)$/,
    MetaOops:/^(?:oops)$/,
    MetaRestart:/^mulai ulang$/,
    MetaScore:/^skor$/,
    MetaPronouns:/^kata ganti$/,
    MetaTopicsNote:/^topik?$/,    
    ...
    // Use item
    Examine:/^(?:periksa|exam|ex|x|deskripsikan) (.+)$/,
    LookAt:/^(?:lihat pada|lihat|l) (.+)$/,
    LookOut:/^(?:lihat keluar dari|lihat keluar) (.+)$/,
    LookBehind:/^(?:lihat di belakang|periksa di belakang) (.+)$/,
    LookUnder:/^(?:lihat di bawah|periksa di bawah) (.+)$/,
    LookInside:/^(?:lihat di dalam|lihat dalam) (.+)$/,
    LookThrough:/^(?:lihat|mengintip) (?:ke bawah|melalui) (.+)$/,
    Search:/^(?:cari) (.+)$/,
    Take:/^(?:ambil|dapatkan|ambil|t|tangkap) (.+)$/,
    Drop:/^(?:jatuhkan|d|buang) (.+)$/,
    Wear2:/^kenakan (?:saya|kamu|dia) (.+)$/,
    Wear:/^(?:pakai|kenakan) (?:saya|kamu|dia) (.+)$/,
    Remove:/^(?:lepas|lepaskan|copot|buang) (?:saya|kamu|dia) (.+)$/,
    Remove2:/^ambil (?:saya|kamu|dia) (.+) off$/,
    Read:/^(?:baca|r) (.+)$/,
    SmellItem:/^(?:cium|sniff) (.+)$/,
    ListenToItem:/^(?:dengar|dengarkan) (.+)$/,
    Purchase:/^(?:beli) (.+)$/,
    Sell:/^(?:jual) (.+)$/,
    Smash:/^(?:hancurkan|pecahkan|hancurkan|pecahkan|tikam|tusuk|pecahkan) (.+)$/,
    Turn:/^(?:putar|putar|pilin) (.+)$/,
    TurnLeft:/^(?:putar|putar|pilin) (.+) (?:kiri|berlawanan arah jarum jam|widdershins)$/,
    TurnRight:/^(?:putar|putar|pilin) (.+) (?:kanan|searah jarum jam)$/,
    SwitchOn:/^(?:nyalakan|hidupkan|aktifkan) (.+)$/,
    SwitchOn2:/^(?:putar|hidupkan) (.+) nyala$/,
    SwitchOff2:/^(?:matikan|deaktifkan) (.+) off$/,
    SwitchOff:/^(?:matikan|nonaktifkan) (.+)$/,
    Open:/^(?:buka) (.+)$/,
    OpenWith:[
      /^(?:buka) (.+) (?:dengan|menggunakan) (.+)$/,
      {regex:/^(?:gunakan|dengan|menggunakan) (.+?) (?:untuk membuka|buka) (.+)$/, mod:{reverse:true}},
    ],
    Close:/^(?:tutup) (.+)$/,
    Lock:/^(?:kunci) (.+)$/,
    LockWith:[
      /^(?:kunci) (.+) (?:dengan|menggunakan) (.+)$/,
      {regex:/^(?:gunakan|dengan|menggunakan) (.+?) (?:untuk mengunci|kunci) (.+)$/, mod:{reverse:true}},
    ],
    Unlock:/^(?:buka kunci) (.+)$/,
    UnlockWith:[
      /^(?:buka kunci) (.+) (?:dengan|menggunakan) (.+)$/,
      {regex:/^(?:gunakan|dengan|menggunakan) (.+?) (?:untuk membuka kunci|buka kunci) (.+)$/, mod:{reverse:true}},
    ],
    Push:/^(?:dorong|tekan) (.+)$/,
    Pull:/^(?:tarik|seret) (.+)$/,
    Fill:/^(?:isi) (.+)$/,
    Empty:/^(?:kosongkan|buang|tuangkan) (.+)$/,
    Eat:/^(makan|beri makan|makan|santap|santap|makan malam|makan malam) (.+)$/,
    Drink:/^(minum|imbibe|quaff|guzzle|knock back|swig|swill|sip|habiskan|chug) (.+)$/,
    Ingest:/^(konsumsi|telan|cerna) (.+)$/,
    Sit:/^(?:duduk)$/,
    Recline:/^(?:berbaring|berbaring)$/,
    SitOn:/^(?:duduk di|duduk di atas|duduk) (.+)$/,
    StandOn:/^(?:berdiri di|berdiri di atas|berdiri) (.+)$/,
    ReclineOn:/^(?:berbaring di|berbaring di atas|berbaring|berbaring di|berbaring di atas|berbaring) (.+)$/,
    GetOff:/^(?:turun dari|turun) (.+)$/,
    Use:/^(?:gunakan) (.+)$/,
    TalkTo:/^(?:bicara dengan|bicara|berbicara dengan|berbicara|berbincang dengan|berbincang) (.+)$/,
    Topics:/^topik? (?:untuk )?(.+)$/,
    
    Make:/^(?:buat|bangun|konstruksi) (.+)$/,
    MakeWith:[
      /^(?:buat|bangun|konstruksi) (.+) (?:dengan|dari|menggunakan) (.+)$/,
      {regex:/^(?:dengan|dari|menggunakan) (.+) (?:buat|bangun|konstruksi) (.+)$/, mod:{reverse:true}},
      {regex:/^(?:gunakan) (.+) untuk (?:buat|bangun|konstruksi) (.+)$/, mod:{reverse:true}},
    ],
    NpcMake:[
      /^(.+), ?(?:buat|bangun|konstruksi) (.+)$/,
      /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:buat|bangun|konstruksi) (.+)$/,
    ],
    NpcMakeWith:[
      /^(.+), ?(?:buat|bangun|konstruksi) (.+) (?:dengan|dari|menggunakan) (.+)$/,
      /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:buat|bangun|konstruksi) (.+) (?:dengan|dari|menggunakan) (.+)$/,
      {regex:/^(.+), ?(?:dengan|dari|menggunakan) (.+) (?:buat|bangun|konstruksi) (.+)$/, mod:{reverse:true}},
      {regex:/^(?:beri tahu|minta|instruksikan) (.+) untuk (?:dengan|dari|menggunakan) (.+) (?:buat|bangun|konstruksi) (.+)$/, mod:{reverse:true}},
      {regex:/^(.+), ?(?:gunakan) (.+) untuk (?:buat|bangun|konstruksi) (.+)$/, mod:{reverse:true}},
      {regex:/^(?:beri tahu|minta|instruksikan) (.+) untuk (?:gunakan) (.+) untuk (?:buat|bangun|konstruksi) (.+)$/, mod:{reverse:true}},
    ],
    
    GoInItem:/^(?:masuk|masuk ke dalam|di dalam|masuk ke dalam|naik ke dalam|naik ke dalam|masuk ke dalam|masuk ke dalam) (.+)$/,
    GoOutItem:/^(?:keluar|keluar dari|di luar|keluar dari|pergi keluar dari|tinggalkan) (.+)$/,
    GoUpItem:/^(?:naik|naik ke atas|panjat ke atas|panjat|naik) (.+)$/,
    GoDownItem:/^(?:turun|turun ke bawah|panjat ke bawah|turun) (.+)$/,
    GoThroughItem:/^(?:lewati|berjalan melalui) (.+)$/,
    NpcGoInItem:[
      /^(.+), ?(?:masuk|masuk ke dalam|di dalam|masuk ke dalam|naik ke dalam|naik ke dalam|masuk ke dalam|masuk ke dalam) (.+)$/,
      /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:masuk|masuk ke dalam|di dalam|masuk ke dalam|naik ke dalam|naik ke dalam|masuk ke dalam|masuk ke dalam) (.+)$/,
    ],
    NpcGoOutItem:[
      /^(.+), ?(?:keluar|keluar dari|di luar|keluar dari|pergi keluar dari|tinggalkan) (.+)$/,
      /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:keluar|keluar dari|di luar|keluar dari|pergi keluar dari|tinggalkan) (.+)$/,
    ],
    NpcGoUpItem:[
      /^(.+), ?(?:naik|naik ke atas|panjat ke atas|panjat|naik) (.+)$/,
      /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:naik|naik ke atas|panjat ke atas|panjat|naik) (.+)$/,
    ],
    NpcGoDownItem:[
      /^(.+), ?(?:turun|turun ke bawah|panjat ke bawah|turun) (.+)$/,
      /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:turun|turun ke bawah|panjat ke bawah|turun) (.+)$/,
    ],
    NpcGoThroughItem:[
      /^(.+), ?(?:lewati|berjalan melalui) (.+)$/,
      /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:lewati|berjalan melalui) (.+)$/,
    ],
    
    // Misc again
    Say:/^(katakan|teriak|bisik|panggil|menjerit|berteriak) (.+)$/,
    Stand:/^berdiri$|^bangun$|^berdiri$/,
    NpcStand:[/^(.+), ?(?:berdiri|bangun)$/, /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:berdiri|bangun)$/],
    GetFluid:/^(?:ambil|dapatkan|scoop|pick|tangkap)(?:| up) (.+)$/,
    FillWith:/^(?:isi) (.+) (?:dengan) (.+)$/,
    NpcFillWith:[/^(.+), ?(?:isi) (.+) (?:dengan) (.+)$/, /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:isi) (.+) (?:dengan) (.+)$/],
    
    EmptyInto:/^(?:kosongkan|tuang|buang|debit|tuangkan) (.+) (?:ke dalam|ke dalam|di|ke bawah|di atas|di atas|di) (.+)$/,
    NpcEmptyInto:[/^(.+), ?(?:kosongkan|tuang|buang|debit|tuangkan) (.+) (?:ke dalam|ke dalam|di|ke bawah|di atas|di atas|di) (.+)$/, /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:kosongkan|tuang|buang|debit|tuangkan) (.+) (?:ke dalam|ke dalam|di|ke bawah|di atas|di atas|di) (.+)$/],
    EmptyFluidInto:/^(?:kosongkan|tuang|buang|debit|tuangkan) (.+) (?:ke dalam|ke dalam|di|ke bawah|di atas|di atas|di) (.+)$/,
    NpcEmptyFluidInto:[/^(.+), ?(?:kosongkan|tuang|buang|debit|tuangkan) (.+) (?:ke dalam|ke dalam|di|ke bawah|di atas|di atas|di) (.+)$/, /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:kosongkan|tuang|buang|debit|tuangkan) (.+) (?:ke dalam|ke dalam|di|ke bawah|di atas|di atas|di) (.+)$/],
    PutFluidIn:/^(?:taruh|letakkan|jatuhkan) (.+) (?:ke dalam|ke dalam|di|di atas|di atas|di) (.+)$/,
    
    PutIn:/^(?:taruh|letakkan|jatuhkan) (.+) (?:ke dalam|ke dalam|di|di atas|di atas|di) (.+)$/,
    NpcPutIn:[/^(.+), ?(?:taruh|letakkan|jatuhkan|masukkan) (.+) (?:ke dalam|ke dalam|di|di atas|di atas|di) (.+)$/, /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:taruh|letakkan|jatuhkan) (.+) (?:ke dalam|ke dalam|di|di atas|di atas|di) (.+)$/],
    TakeOut:/^(?:ambil|dapatkan|lepas) (.+) (?:dari|dari dalam|keluar dari|dari atas|dari) (.+)$/,
    NpcTakeOut:[/^(.+), ?(?:ambil|dapatkan|lepas) (.+) (?:dari|dari dalam|keluar dari|dari atas|dari) (.+)$/, /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:ambil|dapatkan|lepas) (.+) (?:dari|dari dalam|keluar dari|dari atas|dari) (.+)$/],
    GiveTo:/^(?:beri|tawarkan|ajukan) (.+) (?:ke) (.+)$/,
    NpcGiveTo:[/^(.+), ?(?:beri|tawarkan|ajukan) (.+) (?:ke) (.+)$/, /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:beri|tawarkan|ajukan) (.+) (?:ke) (.+)$/],
    Give:/^(?:beri|tawarkan|ajukan) (.+)$/,
    NpcGive:[/^(.+), ?(?:beri|tawarkan|ajukan) (.+)$/, /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:beri|tawarkan|ajukan) (.+)$/],
    
    TieUp:/^(?:ikat|pasang|hubungkan|kaitkan) (.+)$/,
    TieTo:/^(?:ikat|pasang|hubungkan|kaitkan) (.+) (?:ke) (.+)$/,
    NpcTieUp:[/^(.+), ?(?:ikat|pasang|hubungkan|kaitkan) (.+)$/, /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:ikat|pasang|hubungkan) (.+)$/],
    NpcTieTo:[/^(.+), ?(?:ikat|pasang|hubungkan|kaitkan) (.+) (?:ke) (.+)$/, /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:ikat|pasang|hubungkan) (.+) (?:ke) (.+)$/],
    Untie:/^(?:lepas ikatan|lepas|putuskan|cabut|lepas kait) (.+)$/,
    NpcUntie:[/^(.+), ?(?:lepas ikatan|lepas|putuskan|cabut|lepas kait) (.+)$/, /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:lepas ikatan|lepas|putuskan) (.+)$/],
    UntieFrom:/^(?:lepas ikatan|lepas|putuskan) (.+) (?:dari) (.+)$/,
    NpcUntieFrom:[/^(.+), ?(?:lepas ikatan|lepas|putuskan) (.+) (?:dari) (.+)$/, /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:lepas ikatan|lepas|putuskan) (.+) (?:dari) (.+)$/],
    UseWith:/^(?:gunakan) (.+) (?:dengan|pada) (.+)$/,    

    LookExit:/^(?:lihat|intip|l|melirik) (barat laut|bl|utara|u|timur laut|tl|masuk|masuk|masuk|i|atas|a|barat|b|timur|t|keluar|keluar|keluar|k|bawah|b|tenggara|tg|selatan|s|barat daya|bd)$/,

    PushExit:/^(dorong|tarik|geser|pindahkan) (.+) (barat laut|bl|utara|u|timur laut|tl|masuk|masuk|masuk|i|atas|a|barat|b|timur|t|keluar|keluar|keluar|k|bawah|b|tenggara|tg|selatan|s|barat daya|bd)$/,
    NpcPushExit:[
      /^(.+), ?(dorong|tarik|geser|pindahkan) (.+) (barat laut|bl|utara|u|timur laut|tl|masuk|masuk|masuk|i|atas|a|barat|b|timur|t|keluar|keluar|keluar|k|bawah|b|tenggara|tg|selatan|s|barat daya|bd)$/,
      /^(?:beri tahu|minta|instruksikan) (.+) untuk (dorong|tarik|geser|pindahkan) (.+) (barat laut|bl|utara|u|timur laut|tl|masuk|masuk|masuk|i|atas|a|barat|b|timur|t|keluar|keluar|keluar|k|bawah|b|tenggara|tg|selatan|s|barat daya|bd)$/,
    ],
    AskAbout:/^(?:tanya) (.+?) (tentang|apa|siapa|bagaimana|mengapa|dimana|kapan) (.+)$/,
    TellAbout:/^(?:beri tahu) (.+?) (tentang|apa|siapa|bagaimana|mengapa|dimana|kapan) (.+)$/,
    TalkAbout:[
      /^(?:bicara dengan|bicara dengan|bicara|berbicara dengan|berbicara dengan|berbicara) (.+?) tentang (apa|siapa|bagaimana|mengapa|dimana|kapan) (.+)$/,
      /^(?:bicara dengan|bicara dengan|bicara|berbicara dengan|berbicara dengan|berbicara) (.+?) (tentang|apa|siapa|bagaimana|mengapa|dimana|kapan) (.+)$/,
    ],
    FollowMe:[/^(.+), ?(?:ikut|ikuti saya)$/, /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:ikut|ikuti saya)$/],    
    WaitHere:[
      /^(.+), ?(?:berhenti mengikuti|berhenti mengikuti saya|tunggu|tunggu di sini|tetap|tetap di sini)$/,
      /^(?:beri tahu|minta|instruksikan) (.+) untuk (?:berhenti mengikuti|berhenti mengikuti saya|tunggu|tunggu di sini|tetap|tetap di sini)$/,
    ],
  ...
  buy:"Membeli", // used in the command link in the purchase table
  buy_headings:["Barang", "Harga", ""],
  current_money:"Uang saat ini",
  inside:"di dalam",
  on_top:"di atas",
  carrying:"membawa",
